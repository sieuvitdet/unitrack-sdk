...
- `@unitrack/firebase` (and the matching iOS / Android / Flutter helper
  packages) dropped the Messaging / Crashlytics / Remote Config façades.
  The package is now **Analytics-only**; apps wire those Firebase modules
  themselves (commit `0ab1d31`).
...
| `@unitrack/firebase` (npm)             | `1.1.0` |
| `unitrack` (pub.dev — Flutter)         | `1.2.1` |
| `unitrack_firebase` (pub.dev)          | `1.1.0` |
